Build ui-button from source into
build/ui-button.html, all streamlined and ready to be included.
...
Vulcanize for the speed.
    ...
    gulp.task 'vulcanize', ['elements'], ->
      built = 'build/ui-button.html'
      gulp.src ''
        .pipe shell([
          "vulcanize --inline --strip -o ui-button.html #{__dirname}/build/*.html"
          ])
